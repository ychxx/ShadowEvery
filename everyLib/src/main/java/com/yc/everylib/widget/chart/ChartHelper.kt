...
import com.yc.everylib.utils.YcResources.getDrawable
import com.yc.everylib.utils.YcUI.getDisplayMetrics
import java.util.*
...
//            set.setHighlightLineWidth(1f); //指引线宽度
            ...
            dataSet.fillDrawable = getDrawable(R.drawable.every_selector_chart_fill)
