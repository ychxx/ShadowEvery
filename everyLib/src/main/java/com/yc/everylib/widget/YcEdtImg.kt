...
open class YcEdtImg @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    init {
        ...
        val imgRight2Bg = a.getResourceId(R.styleable.YcEdtImg_ycImgRight2Bg, R.drawable.evey_icon_delete)
        val imgRight2Visibility = a.getInt(R.styleable.YcEdtImg_ycImgRight2Visibility, 0)

        val imgLeftBg = a.getResourceId(R.styleable.YcEdtImg_ycImgLeftBg, R.drawable.evey_icon_delete)
